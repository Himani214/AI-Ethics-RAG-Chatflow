...
- Query documents interactively with **Mistral AI**  
- Maintain conversation history with **Buffer Memory**  
- Summarize ethical debates and provide contextual answers  
...
3. Configure credentials:
   ...
   - Mistral AI key  
4. Upload your AI Ethics PDF.  
5. Run the pipeline and start querying.  
...
- Provides a **scalable template** for future HR and AI projects.  
